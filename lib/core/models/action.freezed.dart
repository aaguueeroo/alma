...
mixin _$GameAction {
 ...
 String? get socialActionType;/// Optional templates for result dialog after group actions. Keys: "allAccepted", "someRejected", "allRejected". Placeholders: {accepted}, {rejected}.
 Map<String, String> get resultDialogTemplates;
...
as String?,resultDialogTemplates: null == resultDialogTemplates ? _self.resultDialogTemplates : resultDialogTemplates // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _GameAction():
return $default(_that.id,_that.name,_that.description,_that.category,_that.timeCost,_that.skillEffects,_that.hiddenMetricEffects,_that.healthEffect,_that.sectionPerformanceEffect,_that.associatedHabit,_that.targetNpcId,_that.moralImpactTemplates,_that.educationLevel,_that.educationProgramId,_that.workJobId,_that.workJobType,_that.logMessage,_that.relationshipTypeIds,_that.conditions,_that.npcResponseChance,_that.npcDeclineConsequences,_that.isGroupAction,_that.relationshipEffects,_that.minAge,_that.maxAge,_that.socialActionType,_that.resultDialogTemplates);}
}
...
/// Optional templates for result dialog after group actions. Keys: "allAccepted", "someRejected", "allRejected". Placeholders: {accepted}, {rejected}.
 final  Map<String, String> _resultDialogTemplates;
/// Optional templates for result dialog after group actions. Keys: "allAccepted", "someRejected", "allRejected". Placeholders: {accepted}, {rejected}.
@override@JsonKey() Map<String, String> get resultDialogTemplates {
  if (_resultDialogTemplates is EqualUnmodifiableMapView) return _resultDialogTemplates;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_resultDialogTemplates);
}
...
as int?,maxAge: freezed == maxAge ? _self.maxAge : maxAge // ignore: cast_nullable_to_non_nullable
as int?,socialActionType: freezed == socialActionType ? _self.socialActionType : socialActionType // ignore: cast_nullable_to_non_nullable
as String?,resultDialogTemplates: null == resultDialogTemplates ? _self._resultDialogTemplates : resultDialogTemplates // ignore: cast_nullable_to_non_nullable
as Map<String, String>,
  ));
}
