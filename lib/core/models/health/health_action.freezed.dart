...
mixin _$HealthAction {
 ...
 String get id; String get name; String get description; HealthActionType get type; int get timeCost; double get physicalHealthEffect; double get mentalHealthEffect; List<String> get canDiagnoseConditionIds; List<String> get canTreatConditionIds; List<AccessCondition> get conditions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,type,timeCost,physicalHealthEffect,mentalHealthEffect,const DeepCollectionEquality().hash(canDiagnoseConditionIds),const DeepCollectionEquality().hash(canTreatConditionIds),const DeepCollectionEquality().hash(conditions));

@override
String toString() {
  return 'HealthAction(id: $id, name: $name, description: $description, type: $type, timeCost: $timeCost, physicalHealthEffect: $physicalHealthEffect, mentalHealthEffect: $mentalHealthEffect, canDiagnoseConditionIds: $canDiagnoseConditionIds, canTreatConditionIds: $canTreatConditionIds, conditions: $conditions)';
}
...
@useResult
$Res call({
 String id, String name, String description, HealthActionType type, int timeCost, double physicalHealthEffect, double mentalHealthEffect, List<String> canDiagnoseConditionIds, List<String> canTreatConditionIds, List<AccessCondition> conditions
});
...
/// Create a copy of HealthAction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = null,Object? type = null,Object? timeCost = null,Object? physicalHealthEffect = null,Object? mentalHealthEffect = null,Object? canDiagnoseConditionIds = null,Object? canTreatConditionIds = null,Object? conditions = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String description,  HealthActionType type,  int timeCost,  double physicalHealthEffect,  double mentalHealthEffect,  List<String> canDiagnoseConditionIds,  List<String> canTreatConditionIds,  List<AccessCondition> conditions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HealthAction() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.type,_that.timeCost,_that.physicalHealthEffect,_that.mentalHealthEffect,_that.canDiagnoseConditionIds,_that.canTreatConditionIds,_that.conditions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String description,  HealthActionType type,  int timeCost,  double physicalHealthEffect,  double mentalHealthEffect,  List<String> canDiagnoseConditionIds,  List<String> canTreatConditionIds,  List<AccessCondition> conditions)  $default,) {final _that = this;
switch (_that) {
case _HealthAction():
return $default(_that.id,_that.name,_that.description,_that.type,_that.timeCost,_that.physicalHealthEffect,_that.mentalHealthEffect,_that.canDiagnoseConditionIds,_that.canTreatConditionIds,_that.conditions);}
}
...
/// Create a copy of HealthAction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? type = null,Object? timeCost = null,Object? physicalHealthEffect = null,Object? mentalHealthEffect = null,Object? canDiagnoseConditionIds = null,Object? canTreatConditionIds = null,Object? conditions = null,}) {
