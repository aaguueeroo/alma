...
_LifeState _$LifeStateFromJson(Map<String, dynamic> json) => _LifeState(
  ...
  eventIdsTriggeredThisYear:
      (json['eventIdsTriggeredThisYear'] as List<dynamic>?)
          ...
          .toList() ??
      const [],
  eventIdsTriggeredInLife:
      (json['eventIdsTriggeredInLife'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  unlockedEventIds:
  ...
  healthState: json['healthState'] == null
      ? null
      : HealthState.fromJson(json['healthState'] as Map<String, dynamic>),
);
...
Map<String, dynamic> _$LifeStateToJson(_LifeState instance) =>
    <String, dynamic>{
      ...
      'eventIdsTriggeredInLife': instance.eventIdsTriggeredInLife,
