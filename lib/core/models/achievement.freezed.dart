...
mixin _$Achievement {
 ...
 String get id; String get key; String get name; String get description; DateTime? get unlockedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,key,name,description,unlockedAt);

@override
String toString() {
  return 'Achievement(id: $id, key: $key, name: $name, description: $description, unlockedAt: $unlockedAt)';
}
...
@useResult
$Res call({
 String id, String key, String name, String description, DateTime? unlockedAt
});
...
/// Create a copy of Achievement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? key = null,Object? name = null,Object? description = null,Object? unlockedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String key,  String name,  String description,  DateTime? unlockedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Achievement() when $default != null:
return $default(_that.id,_that.key,_that.name,_that.description,_that.unlockedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String key,  String name,  String description,  DateTime? unlockedAt)  $default,) {final _that = this;
switch (_that) {
case _Achievement():
return $default(_that.id,_that.key,_that.name,_that.description,_that.unlockedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String key,  String name,  String description,  DateTime? unlockedAt)?  $default,) {final _that = this;
switch (_that) {
case _Achievement() when $default != null:
return $default(_that.id,_that.key,_that.name,_that.description,_that.unlockedAt);case _:
  return null;
...
class _Achievement implements Achievement {
  const _Achievement({required this.id, required this.key, required this.name, required this.description, this.unlockedAt});
...
/// Create a copy of Achievement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? key = null,Object? name = null,Object? description = null,Object? unlockedAt = freezed,}) {
