...
mixin _$LifeState {
 ...
 int get currentYear; int get age; int get health; int get money; int get timeRemaining; SkillSet get skills; List<TraitType> get traits; List<Habit> get habits; List<Relationship> get relationships; List<Section> get sections; HiddenMetrics get hiddenMetrics; int get eventsTriggeredThisYear; List<String> get eventIdsTriggeredThisYear; List<String> get unlockedEventIds; GameEvent? get pendingEvent; bool get isDead; String? get causeOfDeath; Map<String, dynamic> get lifeData; List<MoralImpact> get moralImpacts; List<GameLog> get logs; EducationState? get educationState; WorkState? get workState; SocialState? get socialState;
...
@useResult
$Res call({
 int currentYear, int age, int health, int money, int timeRemaining, SkillSet skills, List<TraitType> traits, List<Habit> habits, List<Relationship> relationships, List<Section> sections, HiddenMetrics hiddenMetrics, int eventsTriggeredThisYear, List<String> eventIdsTriggeredThisYear, List<String> unlockedEventIds, GameEvent? pendingEvent, bool isDead, String? causeOfDeath, Map<String, dynamic> lifeData, List<MoralImpact> moralImpacts, List<GameLog> logs, EducationState? educationState, WorkState? workState, SocialState? socialState
});


$SkillSetCopyWith<$Res> get skills;$HiddenMetricsCopyWith<$Res> get hiddenMetrics;$GameEventCopyWith<$Res>? get pendingEvent;$EducationStateCopyWith<$Res>? get educationState;$WorkStateCopyWith<$Res>? get workState;$SocialStateCopyWith<$Res>? get socialState;
...
/// Create a copy of LifeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentYear = null,Object? age = null,Object? health = null,Object? money = null,Object? timeRemaining = null,Object? skills = null,Object? traits = null,Object? habits = null,Object? relationships = null,Object? sections = null,Object? hiddenMetrics = null,Object? eventsTriggeredThisYear = null,Object? eventIdsTriggeredThisYear = null,Object? unlockedEventIds = null,Object? pendingEvent = freezed,Object? isDead = null,Object? causeOfDeath = freezed,Object? lifeData = null,Object? moralImpacts = null,Object? logs = null,Object? educationState = freezed,Object? workState = freezed,Object? socialState = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentYear,  int age,  int health,  int money,  int timeRemaining,  SkillSet skills,  List<TraitType> traits,  List<Habit> habits,  List<Relationship> relationships,  List<Section> sections,  HiddenMetrics hiddenMetrics,  int eventsTriggeredThisYear,  List<String> eventIdsTriggeredThisYear,  List<String> unlockedEventIds,  GameEvent? pendingEvent,  bool isDead,  String? causeOfDeath,  Map<String, dynamic> lifeData,  List<MoralImpact> moralImpacts,  List<GameLog> logs,  EducationState? educationState,  WorkState? workState,  SocialState? socialState)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LifeState() when $default != null:
return $default(_that.currentYear,_that.age,_that.health,_that.money,_that.timeRemaining,_that.skills,_that.traits,_that.habits,_that.relationships,_that.sections,_that.hiddenMetrics,_that.eventsTriggeredThisYear,_that.eventIdsTriggeredThisYear,_that.unlockedEventIds,_that.pendingEvent,_that.isDead,_that.causeOfDeath,_that.lifeData,_that.moralImpacts,_that.logs,_that.educationState,_that.workState,_that.socialState);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentYear,  int age,  int health,  int money,  int timeRemaining,  SkillSet skills,  List<TraitType> traits,  List<Habit> habits,  List<Relationship> relationships,  List<Section> sections,  HiddenMetrics hiddenMetrics,  int eventsTriggeredThisYear,  List<String> eventIdsTriggeredThisYear,  List<String> unlockedEventIds,  GameEvent? pendingEvent,  bool isDead,  String? causeOfDeath,  Map<String, dynamic> lifeData,  List<MoralImpact> moralImpacts,  List<GameLog> logs,  EducationState? educationState,  WorkState? workState,  SocialState? socialState)  $default,) {final _that = this;
switch (_that) {
case _LifeState():
return $default(_that.currentYear,_that.age,_that.health,_that.money,_that.timeRemaining,_that.skills,_that.traits,_that.habits,_that.relationships,_that.sections,_that.hiddenMetrics,_that.eventsTriggeredThisYear,_that.eventIdsTriggeredThisYear,_that.unlockedEventIds,_that.pendingEvent,_that.isDead,_that.causeOfDeath,_that.lifeData,_that.moralImpacts,_that.logs,_that.educationState,_that.workState,_that.socialState);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _LifeState implements LifeState {
  const _LifeState({required this.currentYear, required this.age, required this.health, required this.money, required this.timeRemaining, required this.skills, required final  List<TraitType> traits, required final  List<Habit> habits, required final  List<Relationship> relationships, required final  List<Section> sections, required this.hiddenMetrics, this.eventsTriggeredThisYear = 0, final  List<String> eventIdsTriggeredThisYear = const [], final  List<String> unlockedEventIds = const [], this.pendingEvent, this.isDead = false, this.causeOfDeath, final  Map<String, dynamic> lifeData = const {}, final  List<MoralImpact> moralImpacts = const [], final  List<GameLog> logs = const [], this.educationState, this.workState, this.socialState}): _traits = traits,_habits = habits,_relationships = relationships,_sections = sections,_eventIdsTriggeredThisYear = eventIdsTriggeredThisYear,_unlockedEventIds = unlockedEventIds,_lifeData = lifeData,_moralImpacts = moralImpacts,_logs = logs;
...
@override $SkillSetCopyWith<$Res> get skills;@override $HiddenMetricsCopyWith<$Res> get hiddenMetrics;@override $GameEventCopyWith<$Res>? get pendingEvent;@override $EducationStateCopyWith<$Res>? get educationState;@override $WorkStateCopyWith<$Res>? get workState;@override $SocialStateCopyWith<$Res>? get socialState;
...
/// Create a copy of LifeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentYear = null,Object? age = null,Object? health = null,Object? money = null,Object? timeRemaining = null,Object? skills = null,Object? traits = null,Object? habits = null,Object? relationships = null,Object? sections = null,Object? hiddenMetrics = null,Object? eventsTriggeredThisYear = null,Object? eventIdsTriggeredThisYear = null,Object? unlockedEventIds = null,Object? pendingEvent = freezed,Object? isDead = null,Object? causeOfDeath = freezed,Object? lifeData = null,Object? moralImpacts = null,Object? logs = null,Object? educationState = freezed,Object? workState = freezed,Object? socialState = freezed,}) {
