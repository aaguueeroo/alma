...
mixin _$LifeState {
 ...
 int get currentYear; int get age; int get health; int get money; int get timeRemaining; SkillSet get skills; List<TraitType> get traits; List<Habit> get habits; List<Relationship> get relationships; List<Section> get sections; HiddenMetrics get hiddenMetrics; int get eventsTriggeredThisYear; List<String> get eventIdsTriggeredThisYear; List<String> get unlockedEventIds; GameEvent? get pendingEvent; bool get isDead; String? get causeOfDeath; Map<String, dynamic> get lifeData; List<MoralImpact> get moralImpacts; List<GameLog> get logs; EducationState? get educationState; WorkState? get workState; SocialState? get socialState; HealthState? get healthState;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,currentYear,age,health,money,timeRemaining,skills,const DeepCollectionEquality().hash(traits),const DeepCollectionEquality().hash(habits),const DeepCollectionEquality().hash(relationships),const DeepCollectionEquality().hash(sections),hiddenMetrics,eventsTriggeredThisYear,const DeepCollectionEquality().hash(eventIdsTriggeredThisYear),const DeepCollectionEquality().hash(unlockedEventIds),pendingEvent,isDead,causeOfDeath,const DeepCollectionEquality().hash(lifeData),const DeepCollectionEquality().hash(moralImpacts),const DeepCollectionEquality().hash(logs),educationState,workState,socialState,healthState]);
...
/// Create a copy of LifeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentYear = null,Object? age = null,Object? health = null,Object? money = null,Object? timeRemaining = null,Object? skills = null,Object? traits = null,Object? habits = null,Object? relationships = null,Object? sections = null,Object? hiddenMetrics = null,Object? eventsTriggeredThisYear = null,Object? eventIdsTriggeredThisYear = null,Object? unlockedEventIds = null,Object? pendingEvent = freezed,Object? isDead = null,Object? causeOfDeath = freezed,Object? lifeData = null,Object? moralImpacts = null,Object? logs = null,Object? educationState = freezed,Object? workState = freezed,Object? socialState = freezed,Object? healthState = freezed,}) {
  return _then(_self.copyWith(
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,currentYear,age,health,money,timeRemaining,skills,const DeepCollectionEquality().hash(_traits),const DeepCollectionEquality().hash(_habits),const DeepCollectionEquality().hash(_relationships),const DeepCollectionEquality().hash(_sections),hiddenMetrics,eventsTriggeredThisYear,const DeepCollectionEquality().hash(_eventIdsTriggeredThisYear),const DeepCollectionEquality().hash(_unlockedEventIds),pendingEvent,isDead,causeOfDeath,const DeepCollectionEquality().hash(_lifeData),const DeepCollectionEquality().hash(_moralImpacts),const DeepCollectionEquality().hash(_logs),educationState,workState,socialState,healthState]);
...
/// Create a copy of LifeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentYear = null,Object? age = null,Object? health = null,Object? money = null,Object? timeRemaining = null,Object? skills = null,Object? traits = null,Object? habits = null,Object? relationships = null,Object? sections = null,Object? hiddenMetrics = null,Object? eventsTriggeredThisYear = null,Object? eventIdsTriggeredThisYear = null,Object? unlockedEventIds = null,Object? pendingEvent = freezed,Object? isDead = null,Object? causeOfDeath = freezed,Object? lifeData = null,Object? moralImpacts = null,Object? logs = null,Object? educationState = freezed,Object? workState = freezed,Object? socialState = freezed,Object? healthState = freezed,}) {
