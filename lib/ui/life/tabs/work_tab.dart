...
class WorkTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Section? workSection = _findSection(SectionType.work);
    final String jobLabel = workSection?.contextLabel ?? '';
    final int performance = workSection?.performance ?? 0;
      ...
      child: Column(
        ...
        children: [
          PersonHeaderWidget(
            ...
            subtitle: jobLabel.isNotEmpty ? jobLabel : l10n.jobTitle,
            detail: l10n.salaryAmount(state.money),
          ),
          kVerticalGap24,
          StatBarWidget(
            label: l10n.effort,
          ...
          kVerticalGap24,
          _ActionButtonsRow(
            leftLabel: l10n.getJob,
            rightLabel: l10n.jobActions,
